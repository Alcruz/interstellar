...
where $\mathcal{L}$ is the linear parabolic operator
...
\begin{subequations} \label{eq:blackscholes:frontfixingmethod:inversetransform:american_options_optimal_price_bc}
  ...
  \end{align}
\end{subequations}
Finally, recall that the terminal condition of $\bar{S}(t)$ is given by \eqref{eq:blackscholes:preliminaries:american_options_terminal_condition}. Moreover, by simple substitution, we can rewrite the terminal conditions of $v(x, t)$ as
